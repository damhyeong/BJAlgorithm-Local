...
“ 6.25 이전의 개인소유 대지들은 99%가 남북, 동서 방향으로 평행한 직사각형 모양이었으므로,
 임씨의 이름이 새겨진 옥구슬이 나오는 모든 지점을 포함하는 가장 작은 남북,
  동서 방향으로 평행한 변을 갖는 직사각형의 대지를 임씨의 소유로 인정한다.” 
...
public class Exam_9063 {
	...
	public static void main(String[] args) throws IOException {
		...
		int minX = Integer.parseInt(st.nextToken()), minY = Integer.parseInt(st.nextToken());
