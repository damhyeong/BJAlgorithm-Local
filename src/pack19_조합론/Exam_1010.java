...
0.5 초 (추가 시간 없음)	128 MB	81679	38132	31117	48.260%
문제
재원이는 한 도시의 시장이 되었다. 
...
public class Exam_1010 {
	...
	public static void main(String[] args) throws IOException {
		...
		while(T --> 0) {
			...
			//Long result = (Long)(factorial(M) / factorial(M - N)) / factorial(N);
			BigInteger result = factorial(M).divide(factorial(M - N)).divide(factorial(N));
	...
	public static BigInteger subFactorial(long num1, long num2) {
		BigInteger result = new BigInteger("1");
